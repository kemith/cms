...
<!-- Side bar end -->
	...
	<div class="content">
	<table align="right" border="2" cellspacing="0" cellpadding="0" style="width:70%;line-height:30px;margin-left:40px;margin-top:60px;border-collapse:collapse;position:fixed;">">
		<tr>
			<th>Sl.No</th>
			<th>Activity Name</th>
			<th>View</th>
			...
			$result_per_page=10;
			$cnt=1;
			$query = mysqli_query($db,"SELECT * FROM activity where user_id='$id' and mode_of_execution='Departmental' ORDER BY id DESC ");
			...
			$sql="SELECT * FROM activity where user_id='$id' and mode_of_execution='Departmental' LIMIT " .$this_page_first_result . ',' .$result_per_page;
			...
			if($query-> num_rows > 0){
				while($row=mysqli_fetch_array($result)){
					...
					<!--<a href="view_material.php?editid=<?php echo htmlentities ($row['id']);?>"><img src="images/view.png" width="25px" style="padding-left:8px" title="View"></a>
					-->
					</tr>
					<?php
		...
		for($page=1;$page<=$number_of_pages;$page++){
			echo '<a href="view_departmental.php?page=' .$page . '" style="background-color:#f44336;display:inline-block;padding:10px 10px;">'.$page. '</a>';
		}
	 }
	?>
	</div>
