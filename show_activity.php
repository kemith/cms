		...
		<tr>
			...
			if($query-> num_rows > 0){
				while ($row = $query->fetch_assoc()){
					...
					<td>&nbsp;&nbsp;&nbsp;&nbsp;<?php  echo htmlentities($row["mode_of_execution"]);?></td>
					<td><a href="show_activity_details.php?editid=<?php echo htmlentities ($row['id']);?>" style="text-decoration:none;">Click here for details</a></td>
					</tr>
					<?php
